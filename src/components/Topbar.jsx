...
function Topbar() {
  ...
  return (
    <nav
      className=" container-fluid p-2 shadow fixed-top navbar navbar-light bg-white "
          ...
          <ul className="navbar-nav ">
            <form className="d-flex">
              <button className="btn btn-outline-danger" type="submit">
                <span onClick={logout} className=" mr-2 fw-bold  ">
                  {" "}
                  LOGOUT
                </span>

                <FontAwesomeIcon
                  className="fas fa-1x fa-laugh-wink"
                  icon={faLaughWink}
                />
              </button>
            </form>
