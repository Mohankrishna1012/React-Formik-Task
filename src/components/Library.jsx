...
function Library() {
  ...
  let loadData = async () => {
    ...
    let books = await axios.get(
      "https://63180e51ece2736550bf999b.mockapi.io/books"
    );
    setBooks(books.data);
    setLoading(false);
  };
  ...
  let bookDelete = async (id) => {
    try {
      ...
      if (ask) {
        await axios.delete(
          `https://63180e51ece2736550bf999b.mockapi.io/books/${id}`
        );
      }
      loadData();
    } catch (error) {
                      ...
                      return (
                        <tr>
                          ...
                          <td>
                            ...
                            <Link
                              to={`/portal/library/edit/${book.id}`}
